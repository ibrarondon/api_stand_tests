...
def negative_assert_symbol(first_name):
    ...
    assert user_response.json()["message"] != "Nombre de usuario o usuaria incorrecto. El nombre solo puede contener letras latinas y la longitud debe ser de 2 a 15 caracteres"
